"Make figure for the astrocyte subcluster from the astrotany cluster

Usage: figure_astrocyte.R --file_sc_obj=<file> --file_functions=<file>
...
# Make featureplots for DE genes between WT and Mutant Astrocytes.
...
# save the markers
filename="astrocyte_markers_wtvstra1.tsv"

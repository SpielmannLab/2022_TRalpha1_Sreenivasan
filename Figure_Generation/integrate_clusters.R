...
Usage: integrate_clusters.R --file_sc_obj=<file> --file_functions=<file> --task=<val>

Options:
  -h --help			Show this screen.
  --file_sc_obj=<file>		The rds file after clustering
  --file_functions=<file> The .R file containing all functions
  --task=<val> The integration method. Either integrate-harmony or integrate-seurat
" -> doc
...
if(task=="integrate-seurat"){
  sc_obj_int <- seurat_integration(sc_obj=sc_obj) #The integration with Seurat function not yielding good results for individual cell types
} else if(task=="integrate-harmony"){
  sc_obj_int <- harmony_integration(sc_obj=sc_obj) #This is the one used for individual cell type
}
